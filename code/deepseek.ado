...
cap prog drop deepseek
program define deepseek
	...
	qui findfile deepseek.ado
	local precmdurl = ustrregexra(r(fn),"/deepseek.ado","")
	...
	if !inlist("`engine'", "deepseek-chat", "deepseek-coder"){
	...
	if "`1'" == "test"{
		...
		shell curl https://api.deepseek.com/chat/completions ///
